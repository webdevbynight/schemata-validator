...
The latest version of schemata-validator is currently supported with security updates.
...
`npm` 10.8.2+ and `pnpm` 10.33.4+ are supported. **`yarn` is not supported.**

## Reporting a vulnerability

Please report (suspected) security vulnerabilities via [GitHub’s security advisory reporting system](https://github.com/webdevbynight/schemata-validator/security/advisories/new).
...
schemata-validator does not support other reporting platforms: all security vulnerabilities must be made via the GitHub Advisory system.

List of some (though not all) platforms **which are not supported:**
- direct e-mail or communication to schemata-validator contributors (Discord or Slack),
- Stack Overflow.
